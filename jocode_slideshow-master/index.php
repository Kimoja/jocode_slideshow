...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./site/css/jquery.tesselate.css">
        
        <script src="./lib/jquery-1.9.1.min.js"></script>
        <script src="./lib/jquery.tesselate.js"></script>
        ...
        <script src="./src/fx/slideshow/tesselate.js"></script>
        <script src="./src/jocode_slideshow_navigation.js"></script>
        <script src="./src/fx/navigation/scroll.js"></script>
        <script src="./src/jocode_slideshow_progress.js"></script>
        <script src="./src/fx/progress/basic.js"></script>
